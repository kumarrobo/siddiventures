      ...
      <div class="bg-light shadow-md rounded p-4">
        <div class="row"> 
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <center class="text-3">Please enter Verification Code sent on your Registered Mobile Number ending with {{$mobile}}.</center>
            ...
            <form method="POST"  id="loginForm" action="{{ route('user.verifyotp') }}">
             @csrf
              <div class="form-group">
                <label for="loginMobile"><b>{{__('ENTER OTP')}}</b></label>

                <input id="otp" type="phone" class="form-control @error('otp') is-invalid @enderror" name="otp" value="{{ old('otp') }}" required autocomplete="otp" autofocus>
                @error('mobile')
              ...
              <button class="btn btn-primary btn-block" type="submit">{{__('VERIFY & LOGIN')}}</button>
            </form>
          </div>
