                ...
                <table class="table table-hover border" style="font-size: 12px;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">{{$value['sender_mobile_number']}}</td>
                      <td class="align-middle">{{$value['bank_location']}}</td>
                      <td class="align-middle">{{$value['bank_branch_code']}}</td>
                      <td class="align-middle">{{$value['sender_account_number']}}</td>
                      <td class="align-middle">{{$value['transaction_number']}}</td>
                      ...
                      <td class="align-middle text-center">
                        ...
                        <?php }else{ ?>
                           <i class="fas fa-times-circle text-4 text-danger" data-toggle="tooltip" data-original-title="Your Request in {{$value['status']}}"></i>
                        <?php } ?>
                      </td>
                    </tr>
                    <?php $count++;} ?>
