                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group ">
                     <div class="row">
                        ...
                        <div class="col-md-7 col-sm-6"><input type="number" name="mobile" id="mobile" class="form-control" required="required" readonly="readonly" value="{{$verifyMobile['mobile']}}"></div>
                      </div>
                    </div>
                    <div class="form-group ">
                     <div class="row">
                        ...
                        <div class="col-md-1 col-sm-1">&nbsp;:</div>
                        <div class="col-md-7 col-sm-6"><input type="text" name="balance" id="balance" class="form-control" required="required" readonly="readonly" value="{{number_format($mobileTransactionBalanceAmount,2)}}"></div>
                      </div>
                    </div>
                     <div class="form-group ">
                     <div class="row">
                        ...
                        <div class="col-md-7">
                        <input type="number" name="r_mobile" id="r_mobile" class="form-control" required="required" readonly="readonly" value="{{$verifyMobile['mobile']}}">
                        </div>
                      </div>
                    </div>
                     <div class="form-group ">
                     <div class="row">
                        ...
                        <div class="col-md-1">&nbsp;:</div>
                        <div class="col-md-7">
                        <input type="text" name="account_name" id="account_name" class="form-control" required="required" readonly="readonly" value="{{$result['VerifybeneficiariesBankAccount']['account_name']}}">
                        </div>
                      </div>
                    </div>
                     <div class="form-group ">
                     <div class="row">
                        ...
                        <div class="col-md-1">&nbsp;:</div>
                        <div class="col-md-7">
                        <input type="text" name="account_number" id="account_number" class="form-control" required="required" readonly="readonly" value="{{$result['VerifybeneficiariesBankAccount']['account_number']}}">
                        </div>
                      </div>
                    </div>
                     <div class="form-group ">
                     <div class="row">
                        ...
                        <div class="col-md-1">&nbsp;:</div>
                        <div class="col-md-7">
                        <input type="text" name="bank_name" id="bank_name" class="form-control" required="required" readonly="readonly" value="{{$result['VerifybeneficiariesBankAccount']['bank_name']}}">
                        </div>
                      </div>
                    </div>
                     <div class="form-group ">
                     <div class="row">
                        ...
                        <div class="col-md-1">&nbsp;:</div>
                        <div class="col-md-7">
                        <input type="text" name="account_ifsc" id="account_ifsc" class="form-control" required="required" readonly="readonly" value="{{$result['VerifybeneficiariesBankAccount']['account_ifsc']}}">
                        </div>
                      </div>
                    </div>
                     <div class="form-group ">
