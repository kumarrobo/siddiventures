          ...
          <div class="row">
              ...
              box-shadow: -5px 8px 24px -17px rgba(0,0,0,0.75); ">
                ...
                <h4 class="" style="font-size: 16px;">{{ __('Wallet Balance Transfer To ') }}{{ __($userDetails['name']) }}-{{ __($userDetails['AgentCode']) }}</h4>
                 <p>
                ...
                <form id="personalInformation" method="post" action="{{route('rotransfertouserwallet',['id'=>$id,'tday'=>$tday])}}" method="POST">
                  @csrf
