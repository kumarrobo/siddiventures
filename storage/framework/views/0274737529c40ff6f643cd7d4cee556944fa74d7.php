            ...
            <div class="row">
               ...
               <div class="col-lg-3" style="border: solid 0px #eee;padding: 20px;"></div>
                <div class="col-lg-6" style="border: solid 0px #eee;padding:5px; font-size: 13px;">
                  ...
                  <?php endif; ?>
                <form action="<?php echo e(route('ropayuconfirmationorder')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="card  mb-3">
...
<?php /**PATH /home/pradeep/Projects/www/html/siddiventures/resources/views/RO/TatkalRecharge/ConfirmTatkalWalletRechargePAYU.blade.php ENDPATH**/ ?>