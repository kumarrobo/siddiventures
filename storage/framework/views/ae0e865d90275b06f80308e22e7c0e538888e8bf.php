          ...
          ============================================= -->
            <div class="row">
              ...
              box-shadow: -5px 8px 24px -17px rgba(0,0,0,0.75); ">
                ...
                <h4 class="mb-4"><?php echo e(__('Wallet Balance Transfer To ')); ?><?php echo e(__($userDetails['name'])); ?></h4>
                 <p>
                ...
                <form id="personalInformation" method="post" action="<?php echo e(route('verifytransfer',['id'=>$id,'tday'=>$tday])); ?>" method="POST">
                  <?php echo csrf_field(); ?>
...
<?php /**PATH /home/childftn/public_html/siddhiventures.com/resources/views/user/Distributor/TransferBalanceToDSAndRo.blade.php ENDPATH**/ ?>