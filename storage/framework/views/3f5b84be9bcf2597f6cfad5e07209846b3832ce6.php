                ...
                <table class="table table-hover border" style="font-size: 12px;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle" nowrap="nowrap"><?php echo e(GeneralHelper::getFullDateFormate($value['transaction_date'])); ?></td>
                      ...
                      <td class="align-middle" nowrap="nowrap"> <?php if(isset($value['WalletRechargePayment'])){ ?><?php echo e(GeneralHelper::getTransactionTypeName($value['WalletRechargePayment']['payment_mode'])); ?>

                        <?php }else{ ?> Wallet Transfer<?php } ?></td>
                      <td class="align-middle"><?php if($value['status']=='Success'){ ?>
                                              <font color="green"><b><?php echo e($value['status']); ?></b></font>
                      <?php }else{ ?>
                        <font color="black"><b><?php echo e($value['status']); ?></b></font>
                        <?php } ?></td>
                      <td class="align-middle" title="<?php echo e($value['remarks']); ?>"><?php echo e(Str::limit($value['remarks'],10)); ?></td>
                      <td class="align-middle"><?php echo e(GeneralHelper::getAmount($value['transfer_charge'])); ?></td>
...
<?php echo $__env->make('layouts.defaultRODashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pradeep/Projects/www/html/siddiventures/resources/views/RO/Report/MyReport.blade.php ENDPATH**/ ?>