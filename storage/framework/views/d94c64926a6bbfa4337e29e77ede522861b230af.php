            ...
            <div class="row">
              ...
              <?php }else{ ?>
                 <p class="alert alert-danger">You Domestic Money Transfer Facilities is not Active.<br/>
                  <small><?php echo e(Auth::user()->notification); ?></small>
                  </p>
...
<?php /**PATH /home/pradeep/Projects/www/html/siddiventures/resources/views/RO/PushBalance/TransferBalanceToROForm.blade.php ENDPATH**/ ?>