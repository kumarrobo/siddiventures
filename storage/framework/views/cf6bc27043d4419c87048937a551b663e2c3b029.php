  ...
  .form-control{
    height: 40px !important;
          ...
          ============================================= -->
            <div class="row">
               ...
               <div class="col-lg-3" style="border: solid 0px #eee;padding: 20px;"></div>
                <div class="col-lg-6" style="border: solid 0px #eee;padding:5px; font-size: 12px;">
                  ...
                  <?php endif; ?>
                <form action="<?php echo e(route('confirmationorder')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="card  mb-3">
            ...
            </div><?php /**PATH /home/childftn/public_html/siddhiventures.com/resources/views/user/Distributor/TatkalRecharge/ConfirmTatkalWalletRechargeEaseBuzz.blade.php ENDPATH**/ ?>