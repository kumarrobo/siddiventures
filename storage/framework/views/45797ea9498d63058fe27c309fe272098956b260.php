                    ...
                    <div class="row">
                     ...
                     <div class="form-group"> 
                      ...
                      <div class="col-md-7">
                       ...
                       <input type="number"  class="form-control" data-bv-field="email" id="email"  placeholder="<?php echo e(__('Enter email address')); ?>" name="email" >
                      </div>
                      </div>
                      </div>
...
<?php /**PATH /home/childftn/public_html/siddhiventures.com/resources/views/user/Distributor/MoneyTransfer/moneyTransferSenderInformation.blade.php ENDPATH**/ ?>