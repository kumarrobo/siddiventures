          ...
          ============================================= -->
            <div class="row">
                  ...
                  <div class="card-body">
                    <div class="form-group ">
                     <div class="row">
                        ...
                        <div class="col-md-7 col-sm-6"><?php echo e($VerifyMobileNumber['sender_name']); ?>,&nbsp;M: <?php echo e($VerifyMobileNumber['mobile']); ?></div>
                      </div>
                    </div>
                    <div class="form-group ">
                     <div class="row">
              ...
              <div class="card  mb-3"  style=" 
                    ...
                    -moz-box-shadow: -5px 8px 24px -17px rgba(0,0,0,0.75);
                    box-shadow: -5px 8px 24px -17px rgba(0,0,0,0.75); ">
                  <div class="card-header"><b class="mb-4"><?php echo e(__('Verifed Account Details')); ?></b></div>
                  <div class="card-body">
                    <div class="form-group ">
...
<?php echo csrf_field(); ?>
<input type="hidden"  id="mobile"   name="mobile"  required="required" value="<?php echo e($VerifyMobileNumber['mobile']); ?>">
</form><?php /**PATH /home/pradeep/Projects/www/html/siddiventures/resources/views/RO/MoneyTransfer/addBankAccount.blade.php ENDPATH**/ ?>