             ...
             <div class="row">
              ...
              <div class="col-lg-6" style="padding: 20px;background-color: cadetblue;">
               ...
               <div class="col-lg-6" style="border: solid 1px #eee;padding: 20px;">
                ...
                <h4 class="mb-4"><?php echo e(__('Monthly')); ?></h4>
...
<?php echo $__env->make('layouts.defaultRODashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pradeep/Projects/www/html/siddiventures/resources/views/RO/dashboard.blade.php ENDPATH**/ ?>