              ...
              <div class="card  bg-default mb-3">
               ...
               <div class="col-lg-1" style="border: solid 0px #eee;padding: 20px;"></div>
                <div class="col-lg-7" style="border: solid 0px #eee;padding:5px; font-size: 12px;">
                  ...
                  <?php endif; ?>
                <form action="<?php echo e(route('ropayuconfirmrecharge')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="card  mb-3">
...
<?php /**PATH /home/pradeep/Projects/www/html/siddiventures/resources/views/RO/TatkalRecharge/TatkalWalletRechargePAYU.blade.php ENDPATH**/ ?>