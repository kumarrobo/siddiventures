          ...
          ============================================= -->
            <div class="row">
              ...
              box-shadow: -5px 8px 24px -17px rgba(0,0,0,0.75); ">
                  ...
                  <div class="card-body">
                    <form action="<?php echo e(route('rotransferaction',['id'=>$id])); ?>" method="POST">
                      <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group ">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-1">&nbsp;:</div>
                        <div class="col-md-7">
                        <input type="text" name="fee" id="fee" class="form-control" required="required" readonly="readonly" value="<?php echo e('Rs.'); ?> <?php echo e(DEFAULT_MONEY_TRANSFER_CHARGE); ?> <?php echo e('Flat'); ?>">
                        </div>
                      </div>
                    </div>
                  <!--  
...
<?php /**PATH /home/pradeep/Projects/www/html/siddiventures/resources/views/RO/MoneyTransfer/TransferMoneyToBankAccount.blade.php ENDPATH**/ ?>